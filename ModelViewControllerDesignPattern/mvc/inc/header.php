...
<html>
    ...
    <head>
        ...
        <style>
            ...
            a{ color: #3399FF;}
            .headeroption{background: #3399ff url("img/php4.png") no-repeat scroll 56px 18px;height: 80px;
                overflow: hidden;padding-left: 160px;}
            .headeroption h2{color: #000;font-size: 30px;padding-top: 5px;text-shadow: 0 1px 1px #fff;}
            .content{ background: #f2f2ff none repeat scroll 0 0; border: 5px solid #3399ff;font-size: 16px;
                line-height: 22px; margin-bottom: 5px;margin-top: 5px;min-height: 420px;overflow: hidden;padding: 10px;}
            ...
            input[type="text"]{border: 1px solid #ddd; margin-bottom: 5px;padding: 5px;font-size: 16px;width: 228px;}
...
<body>
    ...
    <header class="headeroption">
        <h2>Object-Oriented for Beginners</h2>
    </header>
